...
public class CTX {
    ...
    public static String LookupCtxCreateBody(String ClientID, String PurchaseAmount, String OriginID, String ClientTransactionID, String ProductID, String ChannelIndicator, String AlternateClientID,
                                             String SourceID, String ChannelSessionID) {
    ...
    public static String CreateCTXQueryTransactionBody(String ClientID,String AlternateClientID,String ClientTransactionId) {
        ...
        public static String CtxCreateBodyClient2 (String ClientID, String PurchaseAmount, String OriginID, String
        ProductID, String ChannelIndicator, String AlternateClientID,
                String SourceID, String ChannelSessionID){

            {
                String RandomNumbers = getRandomNumbers("1234567891", 10);
                ...
                String requestBody = "<?xml version=" + "'1.0'" + "?>\r\n" +
                        ...
                        "<dateLocalTransaction>0710</dateLocalTransaction>\r\n" +
                        "<originId>" + OriginID + "</originId>\r\n" +
                        "<clientTransactionId>" + RandomNumbers + "lml3fzquv3y4xe-0000</clientTransactionId>\r\n" +
                        "<productId>" + ProductID + "</productId>\r\n" +
                        "<channelIndicator>" + ChannelIndicator + "</channelIndicator>\r\n" +
                        "<alternateClientId>" + AlternateClientID + "</alternateClientId>\r\n" +
                        "<sourceId>" + SourceID + "</sourceId>\r\n" +
