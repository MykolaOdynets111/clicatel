...
import static db.custom_queries.ProductLookupQueries.GET_CLIENT_BY_CLIENT_ID;
...
public class ProductLookupInformationTest extends BaseApiTest {
...
//                    .as("My SQL query result should not ve empty")
//                    .contains("Clickatell Test NG 3");

            soft.assertThat(postgres)
                    .as("Postgres SQL query result should not ve empty")
                    .contains("Eco Bank 101");
        });
    }
