...
public class regression_Raas_Reserve_and_Transact_V2 extends testConfig {
    ...
    public void ReserveAndTransactV2PendingToOKTests(String accountIdentifier,
        ...
        // SQL - UPDATE run recon
        Allure.step("Action Test Step 9 : update cpgtx.tran_log set transactionResponseCode = 2201, transactionType = 'PCH' where transactionResponseCode in (2236, 2240) and clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'");
