...
public class regression_Raas_Reserve_and_Transact_V2 extends testConfig {
    ...
    public void ReserveAndTransactV2StandardSuccessTests(String accountIdentifier,
        ...
        Allure.step("Step.41 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate raas_txn_ref field is correct");
        ...
        Allure.step("Step.42 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate account_identifier field is correct");
        ...
        Allure.step("Step.43 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate amount field is correct");
        ...
        Allure.step("Step.44 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate channel_id field is correct");
        ...
        Allure.step("Step.45 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate channel_session_id field is correct");
        ...
        Allure.step("Step.46 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate client_id field is correct");
        ...
        Allure.step("Step.47 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate client_txn_ref field is correct");
        ...
        Allure.step("Step.48 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate created field exists");
        ...
        Allure.step("Step.49 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate event_type field exists");
        ...
        Allure.step("Step.50 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate created field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "created"));
        ...
        Allure.step("Step.55 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate cdc_update_timestamp field exists");
        ...
        Allure.step("Step.56 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate channel_name field exists");
        ...
        Allure.step("Step.57 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate api_call field is correct");
        ...
        Allure.step("Step.58 --> RAAS DB assertions --> Table: raas.raas_response --> Validate raas_txn_ref field is correct");
        ...
        Allure.step("Step.59 --> RAAS DB assertions --> Table: raas.raas_response --> Validate created field exists");
        ...
        Allure.step("Step.60 --> RAAS DB assertions --> Table: raas.raas_response --> Validate event_type field exists");
        ...
        Allure.step("Step.62 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate transactionId field exists");
        ...
        Allure.step("Step.63 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate clientStan field exists");
        ...
        Allure.step("Step.64 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate originId field is correct");
        ...
        Allure.step("Step.65 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate originatingService field exists");
        ...
        Allure.step("Step.66 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate purchaseAmount field is correct");
        ...
        Allure.step("Step.67 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate transactionState field is correct");
        ...
        Allure.step("Step.71 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate raas_txn_ref field is correct");
        ...
        Allure.step("Step.72 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate amount field is correct");
        ...
        Allure.step("Step.73 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate channel_id field is correct");
        ...
        Allure.step("Step.74 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate channel_name field is correct");
        ...
        Allure.step("Step.75 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate channel_session_id field is correct");
        ...
        Allure.step("Step.76 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate client_txn_ref field is correct");
        ...
        Allure.step("Step.77 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate created field exists");
        ...
        Allure.step("Step.78 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate event_type field is correct");
        ...
        Allure.step("Step.80 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate product_type field is correct");
        ...
        Allure.step("Step.81 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate source_identifier field is correct");
        ...
        Allure.step("Step.82 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate target_identifier field is correct");
        ...
        Allure.step("Step.83 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate timestamp field exists");
        ...
        Allure.step("Step.84 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate cdc_update_timestamp field exists");
        ...
        Allure.step("Step.85 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate raas_txn_ref field is correct");
        ...
        Allure.step("Step.86 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate created field exists");
        ...
        Allure.step("Step.87 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate created field is correct");
        ...
        Allure.step("Step.88 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate reserve_funds_txn_ref field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_response WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "reserve_funds_txn_ref"));

        Allure.step("Step.89 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate response_code field is correct");
        ...
        Allure.step("Step.90 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate cdc_update_timestamp field exists");
        ...
        Allure.step("Step.91 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate response_code field is correct");
        ...
        Allure.step("Step.92 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate created field exists");
        ...
        Allure.step("Step.93 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate created field exists");
        ...
        Allure.step("Step.94 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate raas_txn_ref field is correct");
        ...
        Allure.step("Step.95 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate timestamp field exists");
        ...
        Allure.step("Step.96 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate cdc_update_timestamp field exists");
        ...
        Allure.step("Step.97 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate cdc_update_timestamp field is correct");
        ...
        Allure.step("Step.98 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate fee_amount field exists");
        ...
        Allure.step("Step.99 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate client_share_amount field exists");
        ...
        Allure.step("Step.100 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate settlement_amount field exists");
        ...
        Allure.step("Step.101 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate vend_amount field is correct");
        ...
        Allure.step("Step.102 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate vendor_share_amount field exists");
        ...
        Allure.step("Step.103 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate response_code field is correct");
        ...
        Allure.step("Step.104 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate raas_txn_ref field is correct");
        ...
        Allure.step("Step.105 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate created field exists");
        ...
        Allure.step("Step.106 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate event_type field exists");
        ...
        Allure.step("Step.107 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate response_code field is correct");
        ...
        Allure.step("Step.108 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate cdc_update_timestamp field exists");
    ...
    public void ReserveAndTransactV2PendingToRetryableDeclineToNonRetryableDeclineTests(String accountIdentifier,
        ...
        Allure.step("Action Test Step 6 : Wait 10 seconds for simulator to run and transaction data to process");
        Thread.sleep(10000);
        ...
        Allure.step("Step.37 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate raas_txn_ref field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreDb("raas.raas_request", "raas_txn_ref", "=", ReserveAndTransactV2response.path("raasTxnRef")), ReserveAndTransactV2response.path("raasTxnRef"));

        Allure.step("Step.38 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate account_identifier field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "account_identifier"), accountIdentifier);

        Allure.step("Step.39 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate amount field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "amount"), amount);

        Allure.step("Step.40 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate channel_id field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "channel_id"), channelId);

        Allure.step("Step.41 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate channel_session_id field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "channel_session_id"), channelSessionId);

        Allure.step("Step.42 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate client_id field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "client_id"), clientId);

        Allure.step("Step.43 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate client_txn_ref field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "client_txn_ref"), clientTxnRef);

        Allure.step("Step.44 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate created field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "created"));

        Allure.step("Step.45 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate event_type field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "event_type"));

        Allure.step("Step.46 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate created field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "created"));

        Allure.step("Step.47 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate product_id field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "product_id"), productId);

        Allure.step("Step.48 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate source_identifier field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "source_identifier"), sourceIdentifier);

        Allure.step("Step.49 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate target_identifier field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "target_identifier"), targetIdentifier);

        Allure.step("Step.50 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate timestamp field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "timestamp"));

        //Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV4response.path("raasTxnRef") + "'", "reserve_funds_txn_ref"), reserveFundsTxnRef);

        Allure.step("Step.51 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate cdc_update_timestamp field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "cdc_update_timestamp"));

        Allure.step("Step.52 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate channel_name field exists");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "channel_name"), channelName);

        Allure.step("Step.53 --> RAAS DB assertions --> Table: raas.transaction_log --> Validate api_call field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "api_call"), "reserveAndTransact-v2");
        ...
        Allure.step("Step.54 --> RAAS DB assertions --> Table: raas.raas_response --> Validate raas_txn_ref field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreDb("raas.raas_response", "raas_txn_ref", "=", ReserveAndTransactV2response.path("raasTxnRef")), ReserveAndTransactV2response.path("raasTxnRef"));

        Allure.step("Step.55 --> RAAS DB assertions --> Table: raas.raas_response --> Validate created field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_response WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "created"));

        Allure.step("Step.56 --> RAAS DB assertions --> Table: raas.raas_response --> Validate event_type field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.raas_response WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "event_type"));

        // CTX DB assertions
        Allure.step("Step.57 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate transactionResponseCode field is correct");
        Assert.assertEquals(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "transactionResponseCode"), expectedCTXTransactionResponseCode);

        Allure.step("Step.58 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate transactionId field exists");
        Assert.assertNotNull(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "transactionId"));

        Allure.step("Step.59 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate clientStan field exists");
        Assert.assertNotNull(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "clientStan"));

        Allure.step("Step.60 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate originId field is correct");
        Assert.assertEquals(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "originId"), sourceIdentifier);

        Allure.step("Step.61 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate originatingService field exists");
        Assert.assertNotNull(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "originatingService"));

        Allure.step("Step.62 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate purchaseAmount field is correct");
        Assert.assertEquals(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "purchaseAmount"), amount);

        Allure.step("Step.63 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate transactionState field is correct");
        Assert.assertEquals(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "transactionState"), "C");

        Allure.step("Step.64 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate transactionType field is correct");
        Assert.assertEquals(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "transactionType"), "P");

        Allure.step("Step.65 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate client_id field is correct");
        Assert.assertEquals(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "client_id"), clientId);

        Allure.step("Step.66 --> CTX DB assertions --> Table: cpgtx.tran_log --> Validate product_id field is correct");
        Assert.assertEquals(sqlDataAccess.verifyMySQLCustomSql("SELECT * FROM cpgtx.tran_log WHERE clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "-0000'", "product_id"), productId);
        ...
        sqlDataAccess.verifyMySQLUpdateSql("update cpgtx.tran_log set transactionResponseCode = 2201, transactionType = 'PCH' where transactionResponseCode in (2236, 2240, 2213) and clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "raas_txn_ref");
        ...
        Allure.step("Step.77 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate raas_txn_ref field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "raas_txn_ref"), ReserveAndTransactV2response.path("raasTxnRef"));

        Allure.step("Step.78 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate amount field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "amount"), amount);

        Allure.step("Step.79 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate channel_id field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "channel_id"), channelId);

        Allure.step("Step.80 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate channel_name field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "channel_name"), channelName);

        Allure.step("Step.81 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate channel_session_id field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "channel_session_id"), channelSessionId);

        Allure.step("Step.82 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate client_txn_ref field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "client_txn_ref"), clientTxnRef);

        Allure.step("Step.83 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate created field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "created"));

        Allure.step("Step.84 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate event_type field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "event_type"), "RESERVE_FUND_REQUEST_EVENT");

        Allure.step("Step.85 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate event_type field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "product_id"), productId);

        Allure.step("Step.86 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate product_type field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "product_type"), "3");

        Allure.step("Step.87 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate source_identifier field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "source_identifier"), sourceIdentifier);

        Allure.step("Step.88 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate target_identifier field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "target_identifier"), targetIdentifier);

        Allure.step("Step.89 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate timestamp field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "timestamp"));

        Allure.step("Step.90 --> RAAS DB assertions --> Table: raas.reserve_fund_request --> Validate cdc_update_timestamp field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "cdc_update_timestamp"));
        ...
        Allure.step("Step.91 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate raas_txn_ref field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_response WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "raas_txn_ref"), ReserveAndTransactV2response.path("raasTxnRef"));

        Allure.step("Step.92 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate created field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_response WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "created"));

        Allure.step("Step.93 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate created field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_response WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "event_type"), "RESERVE_FUND_RESPONSE_EVENT");

        Allure.step("Step.94 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate reserve_funds_txn_ref field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_request WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "reserve_funds_txn_ref"));

        Allure.step("Step.95 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate response_code field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_response WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "response_code"), expectedRaasResponseCode);

        Allure.step("Step.96 --> RAAS DB assertions --> Table: raas.reserve_fund_response --> Validate cdc_update_timestamp field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.reserve_fund_response WHERE raas_txn_ref = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "cdc_update_timestamp"));

        // Transaction_result_request

        Allure.step("Step.97 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate response_code field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "response_code"), expectedRaasResultRequestResponseCode);

        Allure.step("Step.98 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate created field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "created"));
        ...
        Allure.step("Step.100 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate raas_txn_ref field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "raas_txn_ref"), ReserveAndTransactV2response.path("raasTxnRef"));

        Allure.step("Step.101 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate timestamp field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "timestamp"));

        Allure.step("Step.102 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate cdc_update_timestamp field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "cdc_update_timestamp"));

        Allure.step("Step.103 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate cdc_update_timestamp field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "reserve_amount"), amount);

        Allure.step("Step.104 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate fee_amount field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "fee_amount"));

        Allure.step("Step.105 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate client_share_amount field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "client_share_amount"));

        Allure.step("Step.106 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate settlement_amount field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "settlement_amount"));

        Allure.step("Step.107 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate vend_amount field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "vend_amount"), amount);

        Allure.step("Step.108 --> RAAS DB assertions --> Table: raas.transaction_result_request --> Validate vendor_share_amount field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_request WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "vendor_share_amount"));

        // Transaction_result_response

        Allure.step("Step.109 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate response_code field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_response WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "response_code"), expectedRaasResultResponseResponseCode);

        Allure.step("Step.110 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate raas_txn_ref field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_response WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "raas_txn_ref"), ReserveAndTransactV2response.path("raasTxnRef"));

        Allure.step("Step.111 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate created field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_response WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "created"));

        Allure.step("Step.112 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate event_type field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_response WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "event_type"));

        Allure.step("Step.113 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate response_code field is correct");
        Assert.assertEquals(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_response WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "response_code"), "202");

        Allure.step("Step.114 --> RAAS DB assertions --> Table: raas.transaction_result_response --> Validate cdc_update_timestamp field exists");
        Assert.assertNotNull(sqlDataAccess.verifyPostgreCustomSql("SELECT * FROM raas.transaction_result_response WHERE raas_txn_ref = '" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "cdc_update_timestamp"));
    ...
    // Data staging for use in test
    @DataProvider(name = "ReserveAndTransactV2PendingToOKTestCases", parallel = false)
    public Object[] ReserveAndTransactV2PendingToOKTestCases() throws IOException, ParseException {

        return new String[][]{

                {testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "accountIdentifier"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "amount"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "channelId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "channelName"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "channelSessionId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "clientId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "clientTxnRef"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "productId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "sourceIdentifier"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "targetIdentifier"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "timestamp"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "expectedRaasResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "expectedMessage"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "expectedHTTPResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "expectedRaasResultRequestResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "expectedRaasResultResponseResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "expectedCTXTransactionResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "simulatorScenario"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_OK_Test", "simulatorResetState")},

        };
    }

    @Step("Reserve and Transact V2 Pending To OK test cases")
    @Test(dataProvider = "ReserveAndTransactV2PendingToOKTestCases", priority = 10)
    public void ReserveAndTransactV2PendingToOKTests(String accountIdentifier,
                                                                                        String amount,
                                                                                        String channelId,
                                                                                        String channelName,
                                                                                        String channelSessionId,
        ...
        // SQL - UPDATE run recon
        Allure.step("Action Test Step 8 : update cpgtx.tran_log set transactionResponseCode = 2201, transactionType = 'PCH' where transactionResponseCode in (2236, 2240) and clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'");
        sqlDataAccess.verifyMySQLUpdateSql("update cpgtx.tran_log set transactionResponseCode = 2201, transactionType = 'PCH' where transactionResponseCode in (2236, 2240) and clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "raas_txn_ref");

        Allure.step("Action Test Step 9 : Wait 10 seconds for pending transaction to process and before executing the CTX DB Assertions");
        Thread.sleep(10000);
    ...
    // Data staging for use in test
    @DataProvider(name = "ReserveAndTransactV2PendingToStuckInProcessingTestCases", parallel = false)
    public Object[] ReserveAndTransactV2PendingToStuckInProcessingTestCases() throws IOException, ParseException {

        return new String[][]{

                {testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "accountIdentifier"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "amount"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "channelId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "channelName"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "channelSessionId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "clientId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "clientTxnRef"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "productId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "sourceIdentifier"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "targetIdentifier"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "timestamp"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "expectedRaasResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "expectedMessage"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "expectedHTTPResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "expectedRaasResultRequestResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "expectedRaasResultResponseResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "expectedCTXTransactionResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "simulatorScenario"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Stuck_In_Processing_Test", "simulatorResetState")},

        };
    }

    @Step("Reserve and Transact V2 Pending To Stuck In Processing test cases")
    @Test(dataProvider = "ReserveAndTransactV2PendingToStuckInProcessingTestCases", priority = 11)
    public void ReserveAndTransactV2PendingToStuckInProcessingTests(String accountIdentifier,
                                                     String amount,
                                                     String channelId,
                                                     String channelName,
                                                     String channelSessionId,
        ...
        Allure.step("Action Test Step 6 : update cpgtx.tran_log set transactionResponseCode = 2603, transactionType = 'P' where transactionResponseCode in (2236, 2240) and clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'");
        sqlDataAccess.verifyMySQLUpdateSql("update cpgtx.tran_log set transactionResponseCode = 2603, transactionType = 'P' where transactionResponseCode in (2236, 2240) and clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "raas_txn_ref");
    ...
    // Data staging for use in test
    @DataProvider(name = "ReserveAndTransactV2PendingToRetryableDeclineToDeclineTestCases", parallel = false)
    public Object[] ReserveAndTransactV2PendingToRetryableDeclineToDeclineTestCases() throws IOException, ParseException {

        return new String[][]{

                {testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "accountIdentifier"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "amount"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "channelId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "channelName"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "channelSessionId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "clientId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "clientTxnRef"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "productId"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "sourceIdentifier"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "targetIdentifier"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "timestamp"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "expectedRaasResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "expectedMessage"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "expectedHTTPResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "expectedRaasResultRequestResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "expectedRaasResultResponseResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "expectedCTXTransactionResponseCode"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "simulatorScenario"),
                        testDataFactory.getTestData("ReserveAndTransactV2datasource.json", "reserveandtransactv2suite", "MTNNG_Pending_To_Retryable_Decline_To_Decline_Test", "simulatorResetState")},

        };
    }

    @Step("Reserve and Transact V2 Pending To Retryable Decline To Decline test cases")
    @Test(dataProvider = "ReserveAndTransactV2PendingToRetryableDeclineToDeclineTestCases", priority = 12)
    public void ReserveAndTransactV2PendingToRetryableDeclineToDeclineTests(String accountIdentifier,
                                                                    String amount,
                                                                    String channelId,
                                                                    String channelName,
                                                                    String channelSessionId,
        ...
        // SQL - UPDATE run recon
        Allure.step("Action Test Step 6 : update cpgtx.tran_log set transactionResponseCode = 2201, transactionType = 'PCH' where transactionResponseCode in (2236, 2240) and clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'");
        sqlDataAccess.verifyMySQLUpdateSql("update cpgtx.tran_log set transactionResponseCode = 2201, transactionType = 'PCH' where transactionResponseCode in (2236, 2240) and clientTransactionId = " + "'" + ReserveAndTransactV2response.path("raasTxnRef") + "'", "raas_txn_ref");
        ...
        Allure.step("Action Test Step 8 : Reset vendor simulator to fail (MTNNG ERROR ERROR_VENDOR_SYSTEM)");
        startSim.SimulatorScenario(simulatorResetState);
